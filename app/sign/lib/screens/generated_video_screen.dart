        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Original text:', style: TextStyle(fontSize: 12, color: Colors.grey)),
                  const SizedBox(height: 4),
                  Text('"$originalText"', style: const TextStyle(fontSize: 15,
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: Row(children: [
                _ActionButton(icon: Icons.replay_rounded, label: 'Replay', onTap: () {}),
              ...
              children: List.generate(5, (i) => GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Icon(
                    ...
                    size: 40, color: const Color(0xFFFFB800),
                  ),
                ),
              )),
            ),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 4),
            Text(label, style: const TextStyle(fontSize: 12, color: Color(0xFF1A1A2E),
